...
{
    _16._m0++;
    _16._m1 = uint(gl_InstanceCustomIndexEXT);
}
...
/////////////////////////////////////////////////////
// Entry point: "closest_hit_barycentrics" (rchit) //
/////////////////////////////////////////////////////
#version 460
#extension GL_EXT_ray_tracing : require
...
layout(location = 0) rayPayloadInEXT _4 _16;
hitAttributeEXT vec2 _172;

void main()
{
    vec3 _183 = vec3((1.0 - _172.x) - _172.y, _172);
    _16._m1 = uint(clamp((_183.x + _183.y) + _183.z, 0.0, 4294967040.0));
}
